...
import 'package:popcorn/movies/presentaion/movie_detail_screen_trail_two.dart';
import 'package:popcorn/movies/presentaion/screens/movie_detail_screen.dart';
                ...
                items: state.nowPlayingMovies.map(
                  (item) {
                    return GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) { return MovieDetailTrailScreen(id: item.id); } ));
